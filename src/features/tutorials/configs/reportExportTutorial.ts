...
export const reportExportTutorial = defineStaticAudioTutorial({
  ...
  steps: [
    ...
    { id: 'export', target: '[data-tour="reports-export"]', title: 'Escolha o formato', objective: 'Localize as opções PDF e Planilha.', narration: 'Escolha o formato mais adequado. Use PDF para leitura e compartilhamento controlado. Use a planilha quando precisar organizar ou analisar os dados em colunas.', action: 'continue' },
  ],
} satisfies TutorialConfig, 'exportacao-relatorios');
