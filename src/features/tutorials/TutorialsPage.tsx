...
const TUTORIAL_VIDEOS = [
  { slug: 'login-clinica', category: 'Acesso', title: 'Seleção de clínica e entrada', description: 'Escolha o ambiente correto e faça uma autenticação segura.' },
  ...
  { slug: 'exportacao-relatorios', category: 'Faturamento', title: 'Exportação em PDF e planilha', description: 'Prepare a consulta e escolha o formato de exportação.' },
  { slug: 'pesquisa-inteligente', category: 'Pesquisa', title: 'Pesquisa textual inteligente', description: 'Localize registros com diferentes termos de pesquisa.' },
