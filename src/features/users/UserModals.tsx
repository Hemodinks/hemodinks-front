    ...
    <Modal titleId="info-title" className="info-modal" onClose={onClose}>
      ...
      <dl className="info-list">
        ...
        <div>
          <dt>CPF</dt>
          <dd>
            <CopyValue label="CPF" value={formattedCpf} />
          </dd>
        </div>
        {isMedicalProfileUser(user) && (
          <>
            <div>
              <dt>CRM</dt>
              <dd>
                <CopyValue label="CRM" value={user.crm || '-'} />
              </dd>
            </div>
            <div>
              <dt>UF do CRM</dt>
    ...
    <Modal titleId="contact-title" className="info-modal contact-modal" onClose={onClose}>
      ...
      <dl className="info-list">
        <div>
          <dt>Email</dt>
          <dd>
            <CopyValue label="email" value={user.email} />
          </dd>
        </div>
        <div>
          <dt>Telefone</dt>
          <dd>
            <CopyValue label="telefone" value={formattedPhone} />
          </dd>
        </div>
      </dl>
    </Modal>
