...
export const MODULE_TUTORIALS: Record<AppView, ModuleTutorial> = {
  dashboard: {
    title: 'Painel',
    summary: 'Acompanhe os principais números da clínica e acesse rapidamente as tarefas do dia.',
    sections: [
      {
        title: 'Visão geral',
        description:
      ...
      },
      {
        ...
        description: 'O menu lateral organiza os módulos liberados para o seu perfil.',
        steps: [
  ...
  users: {
    title: 'Usuários',
    summary: 'Cadastre a equipe, consulte perfis e mantenha os acessos da clínica organizados.',
    sections: [
      {
        title: 'Cadastrar usuário',
        description: 'Crie um acesso informando os dados pessoais e profissionais obrigatórios.',
        steps: [
      ...
      },
      {
        ...
        description: 'O perfil define quais módulos e ações ficam disponíveis para cada pessoa.',
        steps: [
      ...
      },
      {
        ...
        description: 'Use as ações da listagem para corrigir dados ou impedir novos acessos.',
        steps: [
  ...
  profile: {
    title: 'Meu perfil',
    summary: 'Mantenha seus dados pessoais, profissionais e de segurança atualizados.',
    sections: [
      {
        title: 'Dados pessoais',
        description: 'Revise nome, contato e demais informações exibidas no seu perfil.',
        steps: [
      ...
      },
      {
        ...
        description: 'Registros e especialidades ajudam a identificar corretamente o profissional.',
        steps: [
      ...
      {
        title: 'Segurança',
        description: 'Proteja sua conta e evite compartilhar credenciais de acesso.',
        steps: [
  ...
  patients: {
    title: 'Pacientes',
    summary: 'Cadastre pacientes, reúna documentos e consulte o histórico de informações.',
    sections: [
      {
        title: 'Cadastrar paciente',
        description: 'O cadastro centraliza identificação, contato, convênio e dados clínicos.',
        steps: [
      ...
      },
      {
        ...
        description: 'Use a pesquisa para encontrar rapidamente um paciente já cadastrado.',
        steps: [
      ...
      },
      {
        ...
        description: 'Anexe documentos relevantes e registre observações úteis ao atendimento.',
        steps: [
  ...
  attendances: {
    title: 'Atendimentos',
    summary: 'Registre a assistência prestada e prepare os dados que seguirão para faturamento.',
    sections: [
      {
        title: 'Novo atendimento',
        description: 'Associe o paciente, o profissional e a data em que o atendimento ocorreu.',
        steps: [
      ...
      },
      {
        ...
        description: 'Adicione os procedimentos realizados com os códigos e quantidades corretos.',
        steps: [
      ...
      },
      {
        ...
        description: 'O status mostra em qual etapa o registro se encontra.',
        steps: [
  ...
  billing: {
    title: 'Faturamento',
    summary: 'Organize contas médicas, envie faturamentos e acompanhe retornos e glosas.',
    sections: [
      {
        title: 'Criar faturamento',
        description: 'Agrupe os atendimentos prontos para gerar uma cobrança ao convênio.',
        steps: [
  ...
  finance: {
    title: 'Financeiro',
    summary: 'Consulte títulos, registre recebimentos e acompanhe saldos e comprovantes.',
    sections: [
      {
      ...
      },
      {
        ...
        description: 'Baixe total ou parcialmente um título informando valor e forma de pagamento.',
        steps: [
  ...
  prices: {
    ...
    summary: 'Defina valores negociados, percentuais e vigências por convênio e procedimento.',
    sections: [
      {
        title: 'Cadastrar preço',
        description: 'Relacione um convênio a um código CBHPM e informe o valor negociado.',
        steps: [
      ...
      },
      {
        ...
        description: 'As datas determinam quando o preço pode ser aplicado aos atendimentos.',
        steps: [
      ...
      {
        title: 'Editar ou desativar',
        description: 'As ações da listagem permitem manter o histórico sem perder o cadastro.',
        steps: [
  ...
  medicalGroups: {
    ...
    summary: 'Organize profissionais em grupos para facilitar configurações e rotinas da clínica.',
    sections: [
      {
        title: 'Criar grupo',
        description: 'Use um nome claro para identificar a equipe ou finalidade do grupo.',
        steps: [
      ...
      },
      {
        ...
        description: 'Inclua somente os profissionais que devem fazer parte do grupo.',
        steps: [
      ...
      {
        title: 'Manutenção',
        description: 'Edite informações ou desative grupos que deixaram de ser usados.',
        steps: [
  ...
  agenda: {
    ...
    summary: 'Organize compromissos, acompanhe eventos e controle os avisos da equipe.',
    sections: [
      {
        title: 'Navegar pela agenda',
        description: 'Alterne o período para localizar compromissos passados ou futuros.',
        steps: [
      ...
      {
        title: 'Criar evento',
        description: 'Registre data, horário, participantes e informações necessárias.',
        steps: [
      ...
      {
        title: 'Notificações',
        description: 'Os avisos do topo destacam eventos e atualizações que ainda não foram lidos.',
        steps: [
  ...
  settings: {
    title: 'Configuração',
    summary: 'Personalize a experiência e ajuste opções gerais disponíveis para sua conta.',
    sections: [
      {
        title: 'Aparência',
        description: 'Escolha o tema mais confortável para utilizar o sistema.',
        steps: [
      ...
      {
        title: 'Preferências',
        description: 'As preferências controlam comportamentos gerais da sua experiência.',
        steps: [
      ...
      {
        title: 'Boas práticas',
        description: 'Configurações administrativas podem afetar outros usuários.',
        steps: [
  ...
  clinics: {
    title: 'Clínicas',
    summary: 'Cadastre unidades, configure seus módulos e controle a situação de cada clínica.',
    sections: [
      {
        title: 'Cadastrar clínica',
        description: 'Informe os dados cadastrais e de contato da nova unidade.',
        steps: [
      ...
      },
      {
        ...
        description: 'A configuração define quais recursos ficam disponíveis para a unidade.',
        steps: [
      ...
      {
        title: 'Editar ou desativar',
        description: 'Use as ações da tabela para manter dados e acessos atualizados.',
        steps: [
